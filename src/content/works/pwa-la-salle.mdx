...
description: 'Discover the app for the Lasallian District of Bogotá, a PWA designed in Figma and developed in WordPress. Available on the AppStore and PlayStore, it includes a liturgical calendar, PDF reading, songbooks, videos, and more.'
client: La Salle
image:
    url: '@assets/images/portada-la-salle-app.jpg'
    alt: 'La Salle mobile application'
pubDate: 2022-07-15
category: ['Web Development', 'PWA', 'UI-UX']
---
